...
export default function Home() {
  ...
  // Theory marks
  const [assignments, setAssignments] = useState([{ value: "", total: 50 }]);
  ...
  const addAssignment = () => {
    setAssignments([...assignments, { value: "", total: 100 }]);
  };
  ...
  const addLabAssignment = () => {
    setLabAssignments([...labAssignments, { value: "", total: 100 }]);
  };

  const removeAssignment = (index) => {
    const newAssignments = assignments.filter((_, i) => i !== index);
    setAssignments(
      newAssignments.length > 0 ? newAssignments : [{ value: "", total: 100 }]
    );
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-indigo-700">Aggregate Calculator</p>
          </div>
          ...
          {subjectType && (
            <>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border-2 border-indigo-200 rounded-lg focus:outline-none focus:border-indigo-500 text-gray-800"
                      placeholder="Obtained marks"
                    />
                    <span className="flex items-center text-gray-600 font-bold">
                      /
              ...
              {/* Lab Section */}
              {subjectType === "theory+lab" && creditType && (
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        className="flex-1 px-4 py-2 border-2 border-purple-200 rounded-lg focus:outline-none focus:border-purple-500 text-gray-800"
                        placeholder="Obtained marks"
                      />
                      <span className="flex items-center text-gray-600 font-bold">
                        /
              ...
              <div className="flex gap-4 mt-6">
                <button
                  ...
                  className="flex-1 bg-indigo-600 text-white py-4 rounded-lg hover:bg-indigo-700 transition-all font-bold text-lg shadow-lg"
                >
                  Calculate Aggregate
                </button>
                <button
                  onClick={handleReset}
                  className="flex-1 bg-gray-500 text-white py-4 rounded-lg hover:bg-gray-600 transition-all font-bold text-lg shadow-lg"
                >
                  Reset
                </button>
              </div>
        ...
        {showResults && results && (
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {/* Final Aggregate */}
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-8 text-center mb-6">
